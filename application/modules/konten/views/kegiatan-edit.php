  ...
  <div class="well well-content">
    <div class="profile-content">
      ...
      <form action="#" id="form" class="form-horizontal">
        <input type="hidden" name="kode" value="<?=$getdata->uid_nilai?>">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
              <input type="text" class="form-control" value="<?=$getdata->keterangan?>" placeholder="Nama Kegiatan" name="st_input4" id="kegiatan">
          </div>
        </div>
        <div class="form-group">
          ...
          <div class="col-sm-10">
            ...
            <button type="button" id="btnSave" onclick="save('<?=base_url()?><?=$this->uri->segment(1)?>/save?act=update')" class="btn btn-primary">Update</button>
          </div>
        </div>
        </form>
    </div>
