    ...
    <div class="col-md-12">
        ...
        <div class="box box-primary">
            ...
            <form action="" id="form" class="form-horizontal">
                <div class="box-body">
                    <div class="col-md-6">
                        <input type="hidden" name="kode" value="<?=$getdata->uid_kaprodi?>">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control" name="id_dosen" id="id_dosen">
                                    ...
                                    <?php foreach ($daftardosen as $key => $value) { ?>
                                        <option value="<?=$value->uid_dosen?>" <?php if($getdata->id_dosen == $value->uid_dosen): echo "selected"; endif; ?>><?=$value->nama_dosen?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
