<?php
    ...
    $bimbingan_id_kelas = $ci->session->userdata('bimbingan_id_kelas');
    $bimbingan_id_jurusan = $ci->session->userdata('bimbingan_id_jurusan');
    $bimbingan_id_dosen = $ci->session->userdata('bimbingan_id_dosen');
    $bimbingan_semester = $ci->session->userdata('bimbingan_semester');
?>

<div class="row">
    <div class="col-xs-12">
        <div class="box">
            <form action="<?=base_url()?>admin/<?=$this->uri->segment(2)?>/save?act=save&st=mahasiswa" id="form" class="form-horizontal" method="post">
                ...
                <div class="box-body">
                    <div class="pull-Left col-sm-12" style="margin-bottom: 5px;">                    
                        <div class="col-sm-6">
                            <a class="btn btn-info checkbox-toggle"><i class="fa fa-square-o"></i> Select All</a>
                            <div class="btn-group">
                                <button class="btn btn-info" type="submit" name="delete" value="delete"><i class="fa fa-check"></i> Selesai</button>
                            </div>
                        </div>
                    </div>
